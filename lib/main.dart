...
import 'package:zcar/ui/launcher.dart';
import 'package:zcar/ui/pointer_instrument.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'ZCar'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  int _counter = 0;
  final InstrumentController _instrumentController = InstrumentController();
